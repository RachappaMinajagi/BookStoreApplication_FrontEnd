...
export class CartService {
  ...
  constructor(private http:HttpClient) { 
    ...
    saveCart(cart:any){
      return this.http.post("http://localhost:8095/cart/save",cart);
    }

    // Get the data of all the cart enteries/rows from the database by calling backend api's
    getAllCarts(){
      return this.http.get("http://localhost:8095/cart/getAll");
    }
    ...
    getCartByCardId(Id:any){
      return this.http.get("http://localhost:8095/cart/getById/"+Id);
    }
    ...
    updateCartByCartId(Id:any,cart:any){
      return this.http.put("http://localhost:8095/cart/updateById/"+Id,cart);
    }
    ...
    updateCartByCartQuantityByCartId(Id:any,quantity:any){
      return this.http.get("http://localhost:8095/cart/updateCartQuantity/"+Id+"?quantity="+quantity)
    }

    // Deleting the cart by id as path variable
    deleteCartByCartId(Id:any){
      return this.http.delete("http://localhost:8095/cart/delete/"+Id);
    }
